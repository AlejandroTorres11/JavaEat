 ...
 * @author david
 */
public class VentanaPrincipalEmpresa extends javax.swing.JFrame {
    ...
    public VentanaPrincipalEmpresa() {
        initComponents();
        ...
        if (UsuarioActual.getCorreo() != null) {
            ...
            for (Empresa empresa : listaEmpresas) {
                if (correoUsuario != null && correoUsuario.equals(empresa.getCorreo())) {
                    Direccion direccion = empresa.getDireccion();
                    int cpUsuario = direccion.getCp();
                    String nombreUsuario = empresa.getNombre();
...
// Crea un editor de celdas personalizado que no permite la edición
    ...
    private void cbFiltrarCercaniaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbFiltrarCercaniaActionPerformed
        if (cbFiltrarCercania.isSelected()) {
            ...
            int cpUsuario = getCpEmpresaActual();
    ...
    private void cbCambiarCorreoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbCambiarCorreoActionPerformed
        ...
        for (Empresa empresa : listaEmpresas) {
            if (correoUsuario.equals(empresa.getCorreo())) {
    ...
    private void cbDireccionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbDireccionActionPerformed
        ...
        for (Empresa empresa : listaEmpresas) {
            if (correoUsuario.equals(empresa.getCorreo())) {
                ...
                JTextField txtCalle = new JTextField(empresa.getDireccion().getCalle());
                JTextField txtNumero = new JTextField(String.valueOf(empresa.getDireccion().getNumero()));
                JTextField txtCP = new JTextField(String.valueOf(empresa.getDireccion().getCp()));
                JTextField txtCiudad = new JTextField(empresa.getDireccion().getCiudad());
    ...
    private void cbTarjetaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbTarjetaActionPerformed
        ...
        for (Empresa empresa : listaEmpresas) {
            if (correoUsuario.equals(empresa.getCorreo())) {
                // Crear los componentes para el JOptionPane
                JTextField txtNumeroTarjeta = new JTextField(String.valueOf(empresa.getTarjeta().getNumeroTarjeta()));
                JTextField txtFechaExpiracion = new JTextField(empresa.getTarjeta().getFechaExpiracion());
                JTextField txtCVV = new JTextField(String.valueOf(empresa.getTarjeta().getCodigoSeguridad()));
                ...
                if (opcion == JOptionPane.OK_OPTION) {
                    ...
                    empresa.setTarjeta(nuevaTarjeta);
                    Informacion.guardarDatos();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaPrincipalEmpresa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaPrincipalEmpresa().setVisible(true);
